  ...
  const generateReportHTML = (reportData: any[], groupName: string) => {
    ...
    const commonHeaders = `
      <tr style="border-bottom: 2px solid #000; height: 35px;">
        ...
        <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 50px; text-align: center; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold;">तारीख</th>
      ...
      tableRows = reportData.map((loan, index) => {
        ...
        return `
          <tr data-row-index="${index}" data-loan='${JSON.stringify(loan).replace(/'/g, "&apos;")}' style="${rowStyle} border-bottom: 1px solid #ccc; height: 40px; min-height: 40px; cursor: pointer; transition: background-color 0.2s;" onmouseover="this.style.backgroundColor='#f3f4f6'" onmouseout="this.style.backgroundColor=''" class="loan-row">
            ...
            <td style="border-bottom: 1px solid #ccc; border-left: 1px solid #ccc; padding: 4px; text-align: center; width: 50px; font-size: 14px; vertical-align: middle; font-weight: 500;">${shortDate}</td>
            <td style="border-bottom: 1px solid #ccc; border-left: 1px solid #ccc; padding: 4px; text-align: left; width: 65px; font-size: 14px; vertical-align: middle; font-weight: 500; padding-left: 5px;" class="loan-amount">${Math.round(loan.principalAmount).toLocaleString('en-IN')}</td>
            ...
            * { box-sizing: border-box; }
            ...
            @media print {
              ...
              * { 
              ...
              th:nth-child(3), td:nth-child(3) { width: 65px !important; min-width: 65px !important; text-align: left !important; padding-left: 5px !important; }    /* रक्कम */
