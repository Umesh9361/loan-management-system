  ...
  const generateReportHTML = (reportData: any[], groupName: string) => {
    ...
    const commonHeaders = `
      <tr style="border-bottom: 2px solid #000; height: 35px;">
        <th style="border-bottom: 1px solid #000; padding: 2px; width: 38px; text-align: center; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold; box-sizing: border-box;">अ.क्र.</th>
        <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 68px; text-align: center; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold; box-sizing: border-box;">तारीख</th>
        <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 78px; font-size: 8px; text-align: left; line-height: 1.2; height: 35px; vertical-align: middle; font-weight: bold; white-space: nowrap; padding-left: 5px; box-sizing: border-box;">अं.बा.<br/>मूल्य</th>
        <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 155px; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold; box-sizing: border-box;">नाव</th>
        <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 65px; text-align: center; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold; box-sizing: border-box;">कोड नं</th>
        <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: auto; min-width: 60px; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold; box-sizing: border-box;">वस्तूचा तपशील</th>
        <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 56px; text-align: center; font-size: 12px; height: 35px; vertical-align: middle; font-weight: bold; box-sizing: border-box;">वजन</th>
      </tr>
    `;
    ...
    const maturityHeaders = `
      <tr style="border-bottom: 2px solid #000; height: 45px;">
        ...
        <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 8px; width: 54px; text-align: center; font-size: 12px; height: 45px; vertical-align: middle; font-weight: bold;">कोड नं</th>
    ...
    if (activeTab === 'date-wise') {
      ...
      tableHeaders = `
        <tr style="border-bottom: 2px solid #000; height: 35px;">
          <th style="border-bottom: 1px solid #000; padding: 2px; width: 32px; text-align: center; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold;">अ.क्र.</th>
          <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 62px; text-align: center; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold;">कर्ज तारीख</th>
          <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 62px; text-align: center; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold;">बंद तारीख</th>
          ...
          <th style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 100px; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold; text-align: left; padding-left: 4px;">नाव</th>
          <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 48px; text-align: center; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold;">कोड नं</th>
          <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: auto; min-width: 50px; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold; text-align: left;">वस्तूचा तपशील</th>
          <th class="mobile-hide" style="border-bottom: 1px solid #000; border-left: 1px solid #000; padding: 2px; width: 46px; text-align: center; font-size: 11px; height: 35px; vertical-align: middle; font-weight: bold;">वजन</th>
        </tr>
      `;
      ...
      tableRows = reportData.map((loan, index) => {
        ...
        return `
          <tr data-row-index="${index}" data-loan='${JSON.stringify(loan).replace(/'/g, "&apos;")}' style="border-bottom: 1px solid #ccc; height: auto; cursor: pointer; transition: background-color 0.2s;" onmouseover="this.style.backgroundColor='#f3f4f6'" onmouseout="this.style.backgroundColor=''" class="loan-row">
            <td style="border-bottom: 1px solid #ccc; padding: 3px 2px; text-align: center; width: 32px; font-size: 13px; vertical-align: middle; font-weight: 500;">${index + 1}</td>
            <td style="border-bottom: 1px solid #ccc; border-left: 1px solid #ccc; padding: 3px 2px; text-align: center; width: 62px; font-size: 13px; vertical-align: middle; font-weight: 500;">${shortLoanDate}</td>
      ...
      tableRows = reportData.map((loan, index) => {
        ...
        return `
          <tr data-row-index="${index}" data-loan='${JSON.stringify(loan).replace(/'/g, "&apos;")}' class="maturity-report-row loan-row" style="border-bottom: 1px solid #e2e8f0; height: 42px; background-color: ${rowBgColor}; transition: background-color 0.2s; cursor: pointer;" onmouseover="this.style.backgroundColor='${hoverColor}'; const maturityCell = this.querySelector('.maturity-cell-maturity'); if(maturityCell) { maturityCell.style.backgroundColor='#ffffff'; maturityCell.style.color='#1f2937'; maturityCell.style.fontWeight='700'; }" onmouseout="this.style.backgroundColor='${rowBgColor}'; const maturityCell = this.querySelector('.maturity-cell-maturity'); if(maturityCell) { maturityCell.style.backgroundColor='#fef2f2'; maturityCell.style.color='#dc2626'; maturityCell.style.fontWeight='700'; }">\
            ...
            <td class="maturity-cell-name" style="border-left: 1px solid #e5e7eb; padding: 8px 4px; width: 155px; font-size: 14px; font-weight: 500; color: #1f2937; vertical-align: middle; white-space: normal; word-break: break-word;">${getPhotoIndicator(loan.id)}${loan.borrowerName}</td>
    ...
    if (activeTab === 'closing-wise') {
      totalsRow = `
        <tr class="total-row" style="border-top: 2px solid #000; border-bottom: 2px solid #000; background-color: #f9f9f9; font-weight: bold; height: 40px;">
          ...
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-left: none; border-right: none; padding: 3px 2px; vertical-align: middle;"></td>
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-left: none; border-right: none; padding: 3px 4px 3px 2px; text-align: left; font-size: 12px; font-weight: bold; vertical-align: middle;">${weightDisplay}</td>
        </tr>
      `;
    } else if (activeTab === 'maturity-wise') {
      ...
      totalsRow = `
        <tr class="total-row" style="border-top: 2px solid #000; border-bottom: 2px solid #000; background-color: #f9f9f9; font-weight: bold; height: 40px;">
          ...
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-left: none; border-right: none; padding: 4px; vertical-align: middle;"></td>
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-left: none; border-right: none; padding: 4px 4px 4px 2px; text-align: left; font-size: 14px; font-weight: bold; vertical-align: middle;">${weightDisplay}</td>
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; border-left: none; border-right: none; padding: 4px; vertical-align: middle;"></td>
        </tr>
      `;
    } else {
      ...
      totalsRow = `
        <tr class="total-row" style="border-top: 2px solid #000; border-bottom: 2px solid #000; background-color: #f9f9f9; font-weight: bold; height: 40px;">
          ...
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; padding: 4px; vertical-align: middle;"></td>
          <td class="mobile-hide" style="border-top: 2px solid #000; border-bottom: 2px solid #000; padding: 4px 4px 4px 2px; text-align: left; font-size: 14px; font-weight: bold; vertical-align: middle;">${weightDisplay}</td>
        </tr>
      `;
    }
            ...
            * { box-sizing: border-box; }
            ...
            @media print {
              ...
              * { 
              ...
              th:nth-child(1), td:nth-child(1) { width: 38px !important; min-width: 38px !important; text-align: center !important; box-sizing: border-box !important; }    /* अनुक्रमांक */
            ...
            @media print {
              * { 
              ...
              body[data-report-type="name-wise"] th:nth-child(1), body[data-report-type="name-wise"] td:nth-child(1) { width: 40px !important; min-width: 40px !important; max-width: 44px !important; text-align: center !important; box-sizing: border-box !important; }
              body[data-report-type="date-wise"] th:nth-child(2), body[data-report-type="date-wise"] td:nth-child(2),
              body[data-report-type="name-wise"] th:nth-child(2), body[data-report-type="name-wise"] td:nth-child(2) { width: 68px !important; min-width: 68px !important; max-width: 72px !important; text-align: center !important; box-sizing: border-box !important; }
              body[data-report-type="date-wise"] th:nth-child(3), body[data-report-type="date-wise"] td:nth-child(3),
              body[data-report-type="name-wise"] th:nth-child(3), body[data-report-type="name-wise"] td:nth-child(3) { width: 78px !important; min-width: 78px !important; max-width: 82px !important; text-align: left !important; padding-left: 5px !important; box-sizing: border-box !important; }
              body[data-report-type="date-wise"] th:nth-child(4), body[data-report-type="date-wise"] td:nth-child(4),
              body[data-report-type="name-wise"] th:nth-child(4), body[data-report-type="name-wise"] td:nth-child(4) { width: 155px !important; min-width: 155px !important; text-align: left !important; padding-left: 4px !important; box-sizing: border-box !important; }
              body[data-report-type="date-wise"] th:nth-child(5), body[data-report-type="date-wise"] td:nth-child(5),
              body[data-report-type="name-wise"] th:nth-child(5), body[data-report-type="name-wise"] td:nth-child(5) { width: 65px !important; min-width: 65px !important; max-width: 69px !important; text-align: center !important; box-sizing: border-box !important; }
              body[data-report-type="date-wise"] th:nth-child(6), body[data-report-type="date-wise"] td:nth-child(6),
              body[data-report-type="name-wise"] th:nth-child(6), body[data-report-type="name-wise"] td:nth-child(6) { width: auto !important; min-width: 60px !important; text-align: left !important; padding-left: 5px !important; box-sizing: border-box !important; }
              body[data-report-type="date-wise"] th:nth-child(7), body[data-report-type="date-wise"] td:nth-child(7),
              body[data-report-type="name-wise"] th:nth-child(7), body[data-report-type="name-wise"] td:nth-child(7) { width: 56px !important; min-width: 56px !important; max-width: 60px !important; text-align: center !important; box-sizing: border-box !important; }
              ...
              /* ═══════════════════════════════════════════════════════════════
                 ...
                 ═══════════════════════════════════════════════════════════════ */
              body[data-report-type="closing-wise"] th:nth-child(1), body[data-report-type="closing-wise"] td:nth-child(1) { width: 40px !important; min-width: 40px !important; max-width: 44px !important; text-align: center !important; padding: 3px 2px !important; }
              body[data-report-type="closing-wise"] th:nth-child(2), body[data-report-type="closing-wise"] td:nth-child(2) { width: 67px !important; min-width: 67px !important; max-width: 71px !important; text-align: center !important; }
              ...
              body[data-report-type="closing-wise"] th:nth-child(7), body[data-report-type="closing-wise"] td:nth-child(7) { width: 52px !important; min-width: 52px !important; max-width: 56px !important; text-align: center !important; }
              ...
              /* MATURITY-WISE PRINT — EXACT DATE-WISE WIDTHS + मुदत column (space from वस्तूचा तपशील) */
              body[data-report-type="maturity-wise"] th:nth-child(1), body[data-report-type="maturity-wise"] td:nth-child(1) { width: 40px !important; min-width: 40px !important; max-width: 44px !important; text-align: center !important; box-sizing: border-box !important; }
              body[data-report-type="maturity-wise"] th:nth-child(2), body[data-report-type="maturity-wise"] td:nth-child(2) { width: 68px !important; min-width: 68px !important; max-width: 72px !important; text-align: center !important; box-sizing: border-box !important; }
              body[data-report-type="maturity-wise"] th:nth-child(3), body[data-report-type="maturity-wise"] td:nth-child(3) { width: 78px !important; min-width: 78px !important; max-width: 82px !important; text-align: right !important; padding-right: 5px !important; box-sizing: border-box !important; }
              body[data-report-type="maturity-wise"] th:nth-child(4), body[data-report-type="maturity-wise"] td:nth-child(4) { width: 155px !important; min-width: 155px !important; text-align: left !important; padding-left: 4px !important; box-sizing: border-box !important; white-space: normal !important; overflow: visible !important; text-overflow: clip !important; word-break: break-word !important; }
