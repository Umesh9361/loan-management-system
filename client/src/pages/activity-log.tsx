  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-white">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-3 md:p-4 text-center">
          <div className="text-2xl font-bold text-indigo-700">{stats.total}</div>
          <div className="text-xs md:text-sm text-indigo-600 font-medium">एकूण नोंदी</div>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 md:p-4 text-center">
          ...
          <div className="text-xs md:text-sm text-blue-600 font-medium">आजचे</div>
        </div>
        <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-3 md:p-4 text-center">
          <div className="text-2xl font-bold text-emerald-700">{stats.createCount}</div>
          <div className="text-xs md:text-sm text-emerald-600 font-medium">नवीन तयार</div>
        </div>
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 md:p-4 text-center">
          ...
          <div className="text-xs md:text-sm text-amber-600 font-medium">अपडेट</div>
        </div>
        <div className="bg-red-50 border border-red-200 rounded-lg p-3 md:p-4 text-center">
          ...
          <div className="text-xs md:text-sm text-red-600 font-medium">डिलीट</div>
        </div>
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 md:p-4 text-center">
          ...
          <div className="text-xs md:text-sm text-green-600 font-medium">लॉगिन</div>
        </div>
      </div>
      ...
      <div className="bg-white border rounded-lg p-4 md:p-6 mb-4 space-y-3">
