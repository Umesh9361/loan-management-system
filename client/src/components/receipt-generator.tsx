    ...
    <div class="receipt-container">
        <div class="annual-receipt">
            <div class="receipt-header">
                ...
                <div style="font-size: 8px; line-height: 1.2; margin-top: 1px; color: #444;">(वर्ष संपल्यानंतर ४५ दिवसांच्या आत सावकाराने कर्जदारास द्यावयाचे)</div>
            </div>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .bulk-cell .receipt-header { margin-bottom: 3px !important; padding-bottom: 3px !important; border-bottom: 1px solid #333 !important; }
  .bulk-cell .form-number { font-size: 10px !important; margin-bottom: 1px !important; padding: 0 !important; line-height: 1.3 !important; }
  .bulk-cell .receipt-title { font-size: 9px !important; margin: 1px 0 !important; line-height: 1.3 !important; }
  .bulk-cell .receipt-header div[style*="font-size"] { font-size: 7.5px !important; line-height: 1.2 !important; margin-top: 1px !important; }
  .bulk-cell .field-row { margin: 2.5px 0 !important; font-size: 9.5px !important; line-height: 1.3 !important; }
  .bulk-cell .field-label { font-size: 9.5px !important; }
  .bulk-cell .field-value { font-size: 9.5px !important; min-height: 14px !important; padding: 0 3px 1px 3px !important; margin-left: 4px !important; line-height: 1.3 !important; }
  .bulk-cell .radio-row { font-size: 8.5px !important; margin: 2px 0 !important; gap: 6px !important; line-height: 1.3 !important; }
  .bulk-cell .radio-label { font-size: 8.5px !important; }
  .bulk-cell .radio-option { font-size: 8.5px !important; gap: 2px !important; }
  .bulk-cell .radio-option input[type="radio"] { width: 9px !important; height: 9px !important; }
  .bulk-cell .table-section { margin: 3px 0 !important; font-size: 9px !important; border: 1px solid #333 !important; }
  .bulk-cell .table-row { border-bottom: 1px solid #ccc !important; }
  .bulk-cell .table-cell-label { padding: 2.5px 4px !important; font-size: 9px !important; line-height: 1.3 !important; font-weight: 500 !important; border-right: 1px solid #ccc !important; }
  .bulk-cell .table-cell-value { padding: 2.5px 4px !important; font-size: 9px !important; width: 75px !important; line-height: 1.3 !important; }
  .bulk-cell .company-info { font-size: 8px !important; padding: 2px 4px !important; margin: 3px 0 !important; line-height: 1.3 !important; }
  .bulk-cell .signature-section { margin-top: 5px !important; font-size: 9px !important; }
  .bulk-cell .signature-line { width: 60px !important; height: 12px !important; margin-bottom: 1px !important; }
  .bulk-cell .date-field { font-size: 9px !important; }
</style>
</head>
<body>
${pagesHTML}
  ...
  static generateJawabForm(data: {
    ...
    const nextFy = `${fyEnd}-${parseInt(fyEnd) + 1}`;
    const fyStartShort = fyStart.slice(-2);
    const fyEndShort = fyEnd.slice(-2);
...
<div class="jawab-page">
  ...
  <div class="legal-text">
    <p>मी सावकारी व्यवहाराची किर्द नमुना क्र. 7 व खतावणी नमुना क्र. 9 मध्ये ठेवलेली आहे. कर्जदारास कर्ज देतेवेळी नमुना क्रमांक 12 ची व तारण गहाण पावती नमुना क्रमांक 10 मध्ये अदा करतो. कर्जदाराची वसुली आल्यानंतर कर्जदाराला वसूल पावती नमुना क्रमांक 11 मध्ये अदा करतो. सावकाराचे भांडवल खाते नमुना क्रमांक 13 मध्ये ठेवलेले आहे. सावकारी वर्ष संपल्यानंतर त्या खातेदाराकडून येणे बाकी आहे त्या सर्व खातेदारांना वार्षिक पत्रके नमुना क्रमांक 14 मध्ये पाठवतो. मी सावकारी नियमाप्रमाणे व्याजाची आकारणी करतो. माझे सावकारी वर्ष 01/04/${fyStartShort} ते 31/03/${fyEndShort} असे आहे. संपलेल्या सावकारी वर्षात दिनांक ${maxCapitalDateFormatted} रोजी रुपये ${formatAmt(maxCapitalAmt)}/- इतके जास्तीत जास्त भांडवलाची गुंतवणूक केलेली आहे. सदर गुंतवणुकीवर नियमाप्रमाणे होणारे तपासणी फी रुपये ${formatAmt(inspectionFee)}/- शासकीय खजिन्यात भरणा करून भरणा चलनाची प्रत आपले कार्यालयास त्वरित दाखल करीत आहे.</p>

    <p>मी सावकारी नावाचा व नंबरचा बोर्ड दुकानाच्या दर्शनी भागात दिसेल अशा ठिकाणी लावलेला आहे. मी कोणत्याही सहकारी संस्थेत अगर पतसंस्थेत सभासद नाही व कोणत्याही बँकेतून कर्ज घेतलेले नाही. मी शासकीय सेवेत किंवा कोणत्याही स्थानिक स्वराज्य संस्थेत नोकरीत नाही. मला आयकर व विक्रीकर लागू असून दिनांक 31/03/${fyEndShort} अखेरच्या वर्षात मी आयकर रुपये <span class="blank-field">&nbsp;</span>/- व विक्रीकर रुपये <span class="blank-field">&nbsp;</span>/- भरलेला आहे. मी व्यवसाय कर भरत असून माझा व्यवसाय कर क्रमांक <span class="blank-field" style="min-width:120px;">&nbsp;</span> असा असून व्यवसाय कर भरणा चलनाची झेरॉक्स प्रत सोबत जोडली आहे.</p>

    <p>मी मुंबई सावकारी व्यवहार करताना हरिजन किंवा गिरीजन असे कोणतेही भेदभाव करणार नाही. सावकारी धंद्यात माझ्याशिवाय इतर कोणत्याही भागीदार नाहीत. धंद्यातील सर्व भांडवल माझे स्वतःचे आहे. धंद्याची कोठेही शाखा नाही किंवा उपशाखा नाही. मी सावकारी कायदा अधिनियम 2014 मधील कलम 18, 25 व 26 चे पालन करतो. मी सावकारी कायद्यातील कोणत्याही कलमाचा भंग केलेला नाही. मी कर्जदारांना पाठवायच्या पावतीची प्रत आपले कार्यालयास वेळेवर पाठवीत असतो. त्याची पोच पावत्या माझ्या दप्तरी आहेत. मला भारतीय दंड विधान कायद्यान्वये कोणत्याही प्रकारचा दंड अगर शिक्षा झालेली नाही.</p>

    <p>सन ${fy} या वर्षात झालेल्या सावकारी व्यवहार खालील प्रमाणे आहेत.</p>
  </div>
  ...
  <div class="closing-text">
    <p>परवाना नूतनीकरणाकरिता लागणारे फोटो, रेशन कार्ड, पॅन कार्ड, आधार कार्ड, घराचा उतारा यांची झेरॉक्स प्रत वगैरे कागदपत्रे मूळ अर्जासोबत यापूर्वी जोडलेले आहेत. तपासणी वेळी आपण मागणी केलेले सर्व सावकारी दप्तर आपणास दाखवले व तपासून मला परत मिळाले आहे. त्याची सर्वच जबाबदारी माझी राहील. याबद्दल माझी कोणतीही तक्रार नाही. वरील प्रमाणे लिहिलेला जबाब मी स्वतः आज दिनांक ${jawabDateFmt} रोजी दिलेला असून त्यावर माझी सही केली आहे.</p>
  </div>
