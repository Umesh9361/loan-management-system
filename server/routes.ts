    ...
    try {
      ...
      for (const loan of activeLoans) {
        ...
        allItems.push({
          ...
          marketValue: isSilver ? Math.round(calcMarketValue * 100) / 100 : Math.round(calcMarketValue),
          standard80Loan: isSilver ? Math.round(standard80Loan * 100) / 100 : Math.round(standard80Loan),
          ...
          loadingAmount: isSilver ? Math.round(loadingAmount * 100) / 100 : Math.round(loadingAmount),
