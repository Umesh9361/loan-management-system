...
- **Data Integrity**: Implements redundant borrower information for multiple loans, a dual-entry journal system for cash transactions, and "प्रारंभिक शिल्लक" logic for opening balances.

### Key Features
- **Multi-tenant Architecture**: Ensures complete data isolation and provides robust tenant/user deletion capabilities.
- **User Management**: Role-based access control (admin/clerk) and Super Admin functions with dynamic permission-based routing.
...
- **Reporting**: Provides cash book, capital reports, ledger management, unified account ledger, and comprehensive borrower list reports, including individual loan statements (नमुना नंबर आठ).
